...
public class Metodoextraer extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Forma de Extraer los objetos para llenar ");

        jLabel2.setText("la pantalla del juego:  Pila/Cola");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Metodoextraer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
